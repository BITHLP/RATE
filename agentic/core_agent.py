...
judger_model = "gpt4o"
meta_data_file_path = f"../meta_eval/MENT.jsonl"
failed_file_path = f"./trajectory_{judger_model}_judger/failed_qids.jsonl"
...
def process_metadata(metadata, max_round=10):
    ...
    try:
        ...
        with open(f"./trajectory_{judger_model}_judger/{qid}.json", "w") as f:
